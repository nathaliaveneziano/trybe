  ...
  <details>
    ...
    <table>
      ...
      <tr>
        ...
        <td><strong>03:</strong> Setup</td>
      </tr>
      <tr>
        <td>:black_square_button:</td>
        <td><strong>03:</strong> Fundamentos do Desenvolvimento Web</td>
      </tr>
      <tr>
        <td>:black_square_button:</td>
      ...
      <tr>
        <td>:black_square_button:</td>
        <td><strong>03:</strong> Unix & Bash - Parte 1</td>
      </tr>
      <tr>
        <td>:black_square_button:</td>
        <td><strong>04:</strong> Unix & Bash - Parte 2</td>
      </tr>
      <tr>
        <td colspan="2" align="center">
      ...
      <tr>
        <td>:black_square_button:</td>
        <td><strong>01:</strong> Introdução - HTML & CSS</td>
      </tr>
      <tr>
        <td>:black_square_button:</td>
