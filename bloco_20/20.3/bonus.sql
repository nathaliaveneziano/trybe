...
WHERE name LIKE 'A%'
ORDER BY name ASC;
-- Escreva uma query para exibir o código e nome de todos os projetos que possuam em seu código o número 
-- 3 . Ordene o resultado em ordem alfabética.
...
-- Escreva uma query para exibir o nome e o código de todos os projetos cujo nome NÃO inicie com a 
-- letra A.
SELECT * FROM Scientists.Projects
WHERE Name NOT LIKE 'A%';
-- Escreva uma query para exibir o nome de todos os projetos cujo código contenha a letra H .
SELECT * FROM Scientists.Projects
WHERE LCASE(Code) LIKE '%h%';
