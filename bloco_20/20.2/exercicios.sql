...
SELECT CONCAT('O projeto ', Name, ' precisou de ', Hours, ' horas para ser concluído.') AS Frase
FROM Projects;
...
SELECT CONCAT("Existem ", COUNT(Name), " cientistas na tabela Scientists.") AS Frase FROM Scientists;
